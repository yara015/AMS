...
const handleChangePasswordSubmit = async (event) => {
  ...
  return (
    <div style={styles.container}>
      ...
      <header style={styles.navbar}>
          ...
          <IconButton style={{ color: 'white' }} onClick={() => navigate('/getAllusers')}>
            <People />
          </IconButton>
          <IconButton
  ...
  {user ? (
    <form>
      ...
      <TextField
        label="Flat"
        value={user.flat ? user.flat.number : 'Not Assigned'}
        fullWidth
        margin="normal"
        InputProps={{
          readOnly: true,
...
// import React, { useState, useContext } from 'react';
// import { NotificationImportant, AccountCircle, People, Close } from '@mui/icons-material';
// import { IconButton, Dialog, DialogTitle, DialogContent, Menu, MenuItem } from '@mui/material';
// import { Link, useNavigate } from 'react-router-dom';
// import { DataContext } from '../../Context/UserContext';
// import Profile from './Profile';
//import UpdateFamilyDialog from './updatefamily';
...
//       <aside style={styles.sidebar}>
//         <div style={styles.logo}>
//           <h4>Hitech Apartment Management System</h4>
//         </div>
//         <nav>
//           <ul style={styles.nav}>
//             {features.map((feature, index) => (
...
//           </DialogTitle>
//           <DialogContent>
//             {/* Add content for changing password */}
//           </DialogContent>
//         </Dialog>
//         <Dialog open={openUpdateProfile} onClose={() => handleDialogClose(setOpenUpdateProfile)} maxWidth="md" fullWidth>
//           <DialogTitle>
