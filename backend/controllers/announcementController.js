...
//     // Find and update the announcement to mark as completed
//     const updatedAnnouncement = await Announcement.findByIdAndUpdate(
//       announcementId,
//       { status: 'completed' },
//       { new: true }
...
//     res.status(200).json({ success: true, message: 'Announcement marked as completed successfully.', announcement: updatedAnnouncement });
//   } catch (error) {
//     console.error(error);
//     res.status(500).json({ success: false, message: 'Server error. Please try again later.', error });
//   }
